    ...
    public void setState(int state) {
        ...
        switch(state){
            case STATE_NORMAL:
                ...
                mHintTextView.setText(R.string.text_xlistview_header_hint_normal);
                break;
            case STATE_READY:
                if (mState != STATE_READY) {
                    mArrowImageView.clearAnimation();
                    mArrowImageView.startAnimation(mRotateUpAnim);
                    mHintTextView.setText(R.string.text_xlistview_header_hint_ready);
                }
                break;
            case STATE_REFRESHING:
                mHintTextView.setText(R.string.text_xlistview_header_hint_loading);
                Time time = new Time();
                time.setToNow();
